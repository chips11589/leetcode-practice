...
namespace ChipsTest
{
    ...
    public class SolutionTests
    {
        ...
        [TestMethod]
        [DataRow("daBcd", "ABC", "YES")]
        [DataRow("daBacd", "ABC", "YES")]
        [DataRow("daBaCcd", "ABC", "YES")]
        [DataRow("daBadCcd", "ABC", "YES")]
        [DataRow("daBaDCcd", "ABC", "NO")]
        [DataRow("daBaDaCabdcd", "ABC", "NO")]
        [DataRow("KXzQ", "K", "NO")]
        [DataRow("beFgH", "EFG", "NO")]
        [DataRow("beFGHefgg", "EFG", "NO")]
        [DataRow("beFgabcG", "EFG", "YES")]
        [DataRow("beFHg", "EFG", "NO")]
        [DataRow("beFGG", "EFG", "NO")]
        [DataRow("bEfgG", "EFG", "YES")]
        [DataRow("befgFGefg", "EFG", "YES")]
        [DataRow("beFaFGefg", "EFG", "NO")]
        [DataRow("beFaFGefg", "EFG", "NO")]
        [DataRow("befaFGefg", "EFG", "YES")]
        [DataRow("bEfAFFgG", "EAFFG", "YES")]
        [DataRow("bEffFgG", "EFFG", "YES")]
        [DataRow("bEfAFFAFgG", "EFAFG", "NO")]
        [DataRow("bEfFFgG", "EFFG", "YES")]
        [DataRow("bEffFFgG", "EFFG", "YES")]
        [DataRow("befgEfgG", "EFG", "YES")]
        [DataRow(
        ...
        [TestMethod]
        [DataRow(new int[] { 4, 5, 6, 2, 6, 7, 6, 5, 4 }, 19)]
        [DataRow(new int[] { 7, 6, 5, 4, 6, 4, 5, 6, 2 }, 19)]
        [DataRow(new int[] { 4, 5, 6, 6, 6, 7, 6, 5, 4 }, 18)]
        [DataRow(new int[] { 4, 5, 6, 6, 6, 6, 7, 6, 5, 4 }, 19)]
        [DataRow(new int[] { 4, 5, 6, 6, 6, 6, 7, 7, 7, 6, 5, 4 }, 22)]
        ...
        [TestMethod]
        [DataRow(new int[] { 3, 7, 4, 6, 5 }, 13)]
        [DataRow(new int[] { 2, 1, 5, 8, 4 }, 11)]
        [DataRow(new int[] { 3, 5, -7, 8, 10 }, 15)]
        [DataRow(new int[] { 10, 7, 4, 6 }, 16)]
        [DataRow(new int[] { -10, -7, -4, 6 }, 6)]
        ...
        [TestMethod]
        [DataRow(2, new int[] { 2, 4, 1 }, 2)]
        [DataRow(2, new int[] { 3, 2, 6, 5, 0, 3 }, 7)]
        [DataRow(1, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 11 }, 11)]
        [DataRow(2, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 11 }, 19)]
        [DataRow(3, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 11 }, 23)]
        [DataRow(1, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 2 }, 9)]
        [DataRow(3, new int[] { 3, 2, 6, 5, 3, 6, 9, 1, 2 }, 11)]
        [DataRow(2, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 2 }, 13)]
        [DataRow(3, new int[] { 3, 2, 6, 5, 0, 6, 9, 1, 2 }, 14)]
        ...
        [TestMethod]
        [DataRow(new int[] { 7, 1, 3, 2, 4, 5, 6 }, 5)]
        [DataRow(new int[] { 2, 7, 3, 1, 4, 5, 6 }, 5)]
        [DataRow(new int[] { 4, 3, 1, 2 }, 3)]
        ...
        [TestMethod]
        [DataRow(3, 2, 1, "1-2|3-1|2-3", 4)]
        [DataRow(6, 2, 5, "1-3|3-4|2-4|1-2|2-3|5-6", 12)]
        [DataRow(6, 2, 1, "1-3|3-4|2-4|1-2|2-3|5-6", 8)]
        [DataRow(5, 6, 1, "1-2|1-3|1-4", 15)]
